...
export default async function PublicacionLayout({ children }: { children: ReactNode }) {
  ...
  if (!principal.tenant.modulos.publicacion) {
    return (
      <main className="mx-auto flex min-h-screen max-w-lg items-center px-6">
        <Card className="w-full">
          <CardHeader>
            <CardTitle>El módulo de Publicación no está habilitado</CardTitle>
            <CardDescription>
              Tu inmobiliaria todavía no tiene contratada la Publicación. Escribinos si querés
              activarla.
            </CardDescription>
          </CardHeader>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="mt-1 flex flex-wrap items-center gap-2.5">
              <h1 className="text-xl font-extrabold text-ink sm:text-2xl">Publicación</h1>
