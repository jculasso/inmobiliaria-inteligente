...
/**
 * Boundary de error del segmento `/tasador` (App Router). Sin esto, un error
 ...
 */
export default function TasadorError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <main className="mx-auto flex min-h-screen max-w-lg items-center px-6">
      <Card className="w-full">
        <CardHeader>
          <CardTitle>Algo salió mal en el Tasador</CardTitle>
          <CardDescription>
